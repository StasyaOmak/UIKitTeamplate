...
final class HeaderTableViewCell: UITableViewCell {
    ...
    private let profileImageView = {
        let element = UIImageView(image: .userImageOne)
    ...
    private let addProfileButton = {
        ...
        element.setTitle(Constants.plusSymbol, for: .normal)
        element.setTitleColor(.white, for: .normal)
        element.backgroundColor = .systemPink
        element.layer.cornerRadius = Constants.cornerRadiusAddButton
    ...
    private let myProfileLabel = {
        let element = UILabel()
        element.text = Constants.myProfileText
    ...
    private let profileDesctiptionLabel = {
        let element = UILabel()
        element.text = Constants.profileDesctiptionText
        element.textAlignment = .left
        element.textColor = .black
    ...
    private let editButton = {
        let element = UIButton()
        element.setTitle(Constants.editText, for: .normal)
        element.setTitleColor(.black, for: .normal)
        element.titleLabel?.font = UIFont(name: Constants.verdanaBold, size: 10)
        element.backgroundColor = .buttonProfile
    ...
    private let shareButton = {
        let element = UIButton()
        element.setTitle(Constants.shareText, for: .normal)
        element.setTitleColor(.black, for: .normal)
        element.titleLabel?.font = UIFont(name: Constants.verdanaBold, size: 10)
        element.backgroundColor = .buttonProfile
        element.layer.cornerRadius = 8
    ...
    private let addNewContactButton = {
        let element = UIButton()
        element.setImage(.addNewContact, for: .normal)
        element.backgroundColor = .buttonProfile
        element.layer.cornerRadius = 8
        element.translatesAutoresizingMaskIntoConstraints = false
        return element
    ...
    private lazy var linkButton = {
        let element = UIButton()
        element.setTitle(Constants.linkText, for: .normal)
        element.titleLabel?.font = UIFont(name: Constants.verdana, size: 14)
        element.setTitleColor(.recommendButton, for: .normal)
        element.contentHorizontalAlignment = .left
        element.translatesAutoresizingMaskIntoConstraints = false
        element.addTarget(self, action: #selector(openLink), for: .touchUpInside)
        return element
    }()
