...
final class ProfileStoriesTableViewCell: UITableViewCell {
    ...
    func configure(stories: [ProfileStory]) {
    ...
    private func configureScrollView(storiesCount: Int) {
        stroriesScrollView.contentSize.width = (Constants.storyWidthTwo) * CGFloat(storiesCount)
