...
final class RecommendTableViewCell: UITableViewCell {
    ...
    private let recommendTitleLabel = {
        let element = UILabel()
        element.text = Constants.recommendText
    ...
    private let allButton = {
        ...
        element.titleLabel?.textAlignment = .right
        element.setTitle(Constants.allText, for: .normal)
    ...
    private func configureUI() {
        contentView.backgroundColor = .recommendBackground
        addSubviews()
    ...
    private func createRecommendCard(_ recommends: [Recommend]) {
        ...
        for recommend in recommends {
            ...
            let recommendImageView = UIImageView(image: UIImage(named: recommend.avatarImage))
            recommendImageView.contentMode = .scaleAspectFill
            recommendImageView.clipsToBounds = true
            recommendImageView.layer.cornerRadius = 55
            ...
            subscribeButton.titleLabel?.font = UIFont(name: Constants.verdanaBold, size: 10)
            subscribeButton.setTitleColor(.white, for: .normal)
            subscribeButton.backgroundColor = .recommendButton
            subscribeButton.layer.cornerRadius = 8
            subscribeButton.translatesAutoresizingMaskIntoConstraints = false

            let userNameLabel = UILabel()
            userNameLabel.text = recommend.nikname
            userNameLabel.textAlignment = .center
            userNameLabel.textColor = .black
            userNameLabel.font = UIFont(name: Constants.verdana, size: 10)
